...
class Media
{
    ...
    public function getCastMedia(): array
    {
        return $this->cast_media;
    }

    public function setCastMedia(array $cast_media): static
    {
        $this->cast_media = $cast_media;
